...
export default function Navbar(){
    return(
        <nav className="fixed top-0 w-full bg-gradient-to-r from-gray-800 to-gray-900 text-white p-4 shadow-lg z-10">
            <div className="max-w-5xl mx-auto flex justify-between items-center">
                <h1 className="text-2x1 font-extrabold tracking-tight">Bhai ki Guidance</h1>
